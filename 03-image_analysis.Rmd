...
**1. Organize your file directory structure in a logical, hierarchical structure**
  ...
  - Universal iLAM functions are within ```~/iLAM/scripts/``` or can be downloaded from this zip folder here: `r {xfun::embed_dir("./ilam_scripts/", text='iLAM wrapper functions')}`
