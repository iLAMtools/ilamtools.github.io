...
Alternatively, you may download iLAM functions from this zip folder: `r {xfun::embed_dir("./ilam_scripts/", text='iLAM wrapper functions')}` and reference them with 'source()'
...
plot_movements(file_names,pi_sub_folder,
               by_change,
               x_left, x_right,
               y_bot, y_top,
               n_max)
...
-   First test parameters settings for `find_movements()` with a subset of experimental images: e.g., `find_movements(files = file_names[1:100], p_sample=0.9)`
