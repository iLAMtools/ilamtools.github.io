...
3. Filter movements captured from rare, noisy images.
  ...
  - Noisy values were initially assigned an arbitrary value (2,000,000). This step changes 2,000,000 with NA and then replaces with average value of the preceding and succeeding time points. These rare cases typically only occur at the image following a light-dark transition. For example, across a 7-day experiment (5040 images), only 0.4% image comparisons were assigned an arbitrary value. 
